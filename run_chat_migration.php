...
echo "<h1>Chat System Database Migration</h1>";
echo "<p>Running comprehensive chat system migration...</p>";

try {
    $pdo = getDBConnection();

    // Read the migration SQL file
    $migrationSQL = file_get_contents('chat_system_migration.sql');
    ...
    if ($errorCount === 0) {
        ...
        $tables = ['states', 'cities', 'chat_rooms', 'dm_threads', 'dm_requests', 'dm_messages', 'file_attachments', 'reports', 'user_blocks', 'bad_words', 'user_preferences'];
